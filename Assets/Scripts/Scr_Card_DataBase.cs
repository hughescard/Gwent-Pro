...
public class Scr_Card_DataBase : MonoBehaviour
{
    public static List<Scr_Card> Create_Deck(bool jugador,string faction)
    {
        if(faction == "C_and_R") 
        {
            ...
            C_and_R_Deck.Add(new Scr_Card("Dispersión de Niebla", "W", jugador, Resources.Load<Sprite>("Spr_Dispersion_de_Niebla"), 0, "W", "", "U"));
            C_and_R_Deck.Add(new Scr_Card("Sobrecarga Electromagnética", "W", jugador, Resources.Load<Sprite>("Spr_Sobrecarga_Electromagnetica"), 0, "W", "", "U"));
            C_and_R_Deck.Add(new Scr_Card("Contramedidas de Alta Tecnología", "W", jugador, Resources.Load<Sprite>("Spr_Contramedidas_de_Alta_Tecnologia"), 0, "W", "", "U"));
            C_and_R_Deck.Add(new Scr_Card("Mejoras de Combate", "R", jugador, Resources.Load<Sprite>("Spr_Mejoras_de_Combate"), 0, "Rm", "", "U"));
            C_and_R_Deck.Add(new Scr_Card("Potenciador de Largo Alcance", "R", jugador, Resources.Load<Sprite>("Spr_Potenciador_de_Largo_Alcance"), 0, "Rd", "", "U"));
            C_and_R_Deck.Add(new Scr_Card("Escudo Energético Reforzado", "R", jugador, Resources.Load<Sprite>("Spr_Escudo_Energetico_Reforzado"), 0, "Rs", "", "U"));
            ...
            C_and_R_Deck.Add(new Scr_Card("Titán de Batalla Mejorado", "U", jugador, Resources.Load<Sprite>("Spr_Titan_de_Batalla_Mejorado"), 10, "M", "", "G"));
            C_and_R_Deck.Add(new Scr_Card("Centinela de Vanguardia", "U", jugador, Resources.Load<Sprite>("Spr_Centinela_de_Vanguardia"), 7, "S", "", "S"));
            C_and_R_Deck.Add(new Scr_Card("Vanguardia Táctica", "U", jugador, Resources.Load<Sprite>("Spr_Vanguardia_Tactica"), 6, "D", "", "S"));
            C_and_R_Deck.Add(new Scr_Card("Cazador de Objetivos", "U", jugador, Resources.Load<Sprite>("Spr_Cazador_de_Objetivos"), 8, "D", "", "S"));
        ...
        else
        {
                ...
                CM_Deck.Add(new Scr_Card("Emboscada Relámpago", "W", jugador, Resources.Load<Sprite>("Spr_Emboscada_Relampago"), 0, "W", "", "U"));
                CM_Deck.Add(new Scr_Card("Avance Estratégico", "W", jugador, Resources.Load<Sprite>("Spr_Avance_Estrategico"), 0, "W", "", "U"));
                CM_Deck.Add(new Scr_Card("Asalto Certero", "W", jugador, Resources.Load<Sprite>("Spr_Asalto_Certero"), 0, "W", "", "U"));
                CM_Deck.Add(new Scr_Card("Grito de Batalla", "W", jugador, Resources.Load<Sprite>("Spr_Grito_de_Batalla"), 0, "Rm", "", "U"));
                CM_Deck.Add(new Scr_Card("Bendición_del_Clero", "W", jugador, Resources.Load<Sprite>("Spr_Bendicion_del_Clero"), 0, "Rd", "", "U"));
                CM_Deck.Add(new Scr_Card("Estrategia de Vanguardia", "W", jugador, Resources.Load<Sprite>("Spr_Estrategia_de_Vanguardia"), 0, "Rs", "", "U"));
                ...
                CM_Deck.Add(new Scr_Card("Rey Arturo", "U", jugador, Resources.Load<Sprite>("Spr_Rey_Arturo"), 9, "M", "", "G"));
                CM_Deck.Add(new Scr_Card("Caballero de la Guardia Real", "U", jugador, Resources.Load<Sprite>("Spr_Caballero_de_la_Guardia_Real"), 7, "M", "", "S"));
                CM_Deck.Add(new Scr_Card("Arquero de Élite", "U", jugador, Resources.Load<Sprite>("Spr_Arquero_de_Elite"), 6, "D", "", "S"));
                CM_Deck.Add(new Scr_Card("Cruzado Templario", "U", jugador, Resources.Load<Sprite>("Spr_Cruzado_Templario"), 7, "M", "", "S"));
